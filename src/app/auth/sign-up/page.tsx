...
function SignUpDefault() {
  return (
    <Default
      mainCard={
        <div className="mb-16 mt-2 flex h-full w-full items-center justify-center px-2 md:mx-0 md:px-0 lg:mb-10 lg:items-center lg:justify-start">
          {/* Sign in section */}
          <div className="mx-auto mt-[3vh] w-full max-w-full flex-col items-center  md:pl-4 xl:max-w-[420px]">
            ...
            <InputField
              ...
              extra="mb-3"
              label="Email*"
              placeholder="mail@wuliangtech0118.com"
              id="email"
              type="text"
            />
